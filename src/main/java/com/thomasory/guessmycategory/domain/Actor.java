...
public class Actor implements Serializable {
    ...
    public Actor sessions(Set<Session> sessions) {
        this.sessions = sessions;
        return this;
    }

    public Actor addSession(Session session) {
        this.sessions.add(session);
        session.setActors(this);
        return this;
    }

    public Actor removeSession(Session session) {
        this.sessions.remove(session);
        session.setActors(null);
        return this;
    }
    ...
    public Actor answers(Set<Answer> answers) {
        this.answers = answers;
        return this;
    }

    public Actor addAnswer(Answer answer) {
        this.answers.add(answer);
        answer.setActors(this);
        return this;
    }

    public Actor removeAnswer(Answer answer) {
        this.answers.remove(answer);
        answer.setActors(null);
        return this;
    }
