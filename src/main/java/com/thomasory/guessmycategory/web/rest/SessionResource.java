...
/**
 * REST controller for managing {@link com.thomasory.guessmycategory.domain.Session}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SessionResource {
     ...
     */
    @GetMapping("/sessions")
    public List<Session> getAllSessions(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
